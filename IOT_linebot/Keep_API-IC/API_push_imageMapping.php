...
$type = ($_POST['Type'] == "url") ? "linkUri" : "text";
$Image = $_POST['Image'] . "?_ignored=";
$action = $_POST['Action'];
...
// $Image = "https://cdn.majorcineplex.com/uploads/content/images/1040x1040%2818%29.jpg?_ignored=";
// $type = "linkUri";
// // $type = "text" != "text" ? "text" : $_POST['type'] != "linkUri" ? "linkUri" : "NO ALL" ;
// $action ="https://developers.line.biz/console/channel/1623482821/basic/";

$arrayHeader = array();
$arrayHeader[] = "Content-Type: application/json";
$arrayHeader[] = "Authorization: Bearer {$access_token}";

include("../FlexMassage/ImageMapping.php");
