...
$Image = $_POST['image'];
$Video = !empty($_POST['video']) ? $_POST['video'] : $_POST['image'];
$type = !empty($_POST['video']) ? "video" : "image";
...
// $Video ="https://mokmoon.com/videos/Brown.mp4";

$arrayHeader = array();
$arrayHeader[] = "Content-Type: application/json";
$arrayHeader[] = "Authorization: Bearer {$access_token}";
$arrayPostData['messages'][0]['type'] = $type;
$arrayPostData['messages'][0]['previewImageUrl'] = $Image;
$arrayPostData['messages'][0]['originalContentUrl'] = $Video;
