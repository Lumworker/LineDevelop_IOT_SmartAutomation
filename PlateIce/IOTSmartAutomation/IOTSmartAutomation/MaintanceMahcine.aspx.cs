...
namespace IOTSmartAutomation
{
    public partial class MaintanceMahcine : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static void SP_IOT_BackEnd_Main_Machine(string customer_no, string site_code, int factory_no, string main_machine_ID, string main_machine_desc, string main_machine_type, string main_machine_model, string Certificated, string PLC, string Serial_Number, string Remark, int SetPoint_NextDrop, string main_machine_size, string type)
        {
            new ClassBrowseNew().SP_IOT_BackEnd_Main_Machine(customer_no, site_code, factory_no, main_machine_ID, main_machine_desc, main_machine_type, main_machine_model, Certificated, PLC, Serial_Number, Remark, SetPoint_NextDrop, main_machine_size, type);
        }
        ...
        [WebMethod]
        public static string SP_IOT_BackEnd_Alarm_mst(string alarm_ID, string alarm_name, string alarm_group, string type)
        {
            return new ClassBrowseNew().SP_IOT_BackEnd_Alarm_mst(alarm_ID, alarm_name, alarm_group, type);
        }

        [WebMethod]
        public static string SP_IOT_BackEnd_RawData_mst(string rawdata_ID, string rawdata_name, string rawdata_group, string type)
        {
            return new ClassBrowseNew().SP_IOT_BackEnd_RawData_mst(rawdata_ID, rawdata_name, rawdata_group, type);
        }

        [WebMethod]
        public static void SP_IOT_BackEnd_AlarmLineConfig(string id, string alarm_id, int Seq, int alarm_type, string msg_type, string msg, string prefix, string subfix, int msg_main_type, int alarm_group, string PLC, string Status)
        {
            new ClassBrowseNew().SP_IOT_BackEnd_AlarmLineConfig(id, alarm_id, Seq, alarm_type, msg_type, msg, prefix, subfix, msg_main_type, alarm_group, PLC, Status);
        }
        ...
        [WebMethod]
        public static List<String[]> GetListMachine_group()
        {
            return new ClassBrowseNew().GetListMachine_group();
        }


        [WebMethod]
        public static List<String[]> GetListStandardTime()
        {
            return new ClassBrowseNew().GetListStandardTime();
        }

        [WebMethod]
        public static List<String[]> GetListTimeType()
        {
            return new ClassBrowseNew().GetListTimeType();
        }

        [WebMethod]
        public static List<String[]> GetListSpecialTime()
        {
            return new ClassBrowseNew().GetListSpecialTime();
        }

        [WebMethod]
        public static void SP_IOT_Peak_StandardTime(string mon, string tues, string wend, string thurs, string fri, string sat, string sun, string effDate)
        {
            new ClassBrowseNew().SP_IOT_Peak_StandardTime(mon, tues, wend, thurs, fri, sat, sun, effDate);
        }

        [WebMethod]
        public static void SP_IOT_Peak_SpecialTime(int ID, string specialDate, string timeTypeSpecial, string type)
        {
            new ClassBrowseNew().SP_IOT_Peak_SpecialTime(ID, specialDate, timeTypeSpecial, type);
        }

        [WebMethod]
        public static void SP_IOT_Peak_TimeType(string typeName, string timeStart, string timeEnd, int index)
        {
            new ClassBrowseNew().SP_IOT_Peak_TimeType(typeName, timeStart, timeEnd, index);
        }
