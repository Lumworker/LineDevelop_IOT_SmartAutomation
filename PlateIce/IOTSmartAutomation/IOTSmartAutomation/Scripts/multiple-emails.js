(function( $ ){
	...
	$.fn.multiple_emails = function(options) {
		...
		return this.each(function() {
            ...
            var $input = $('<input type="text" class="form-control multiple_emails-input" autocomplete="off" placeholder="input Email ex: abc@patkol.com"/>').on('keyup', function(e) { // input
