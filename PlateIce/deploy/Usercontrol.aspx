        ...
        $(document).ready(function () {
              ...
              var Status = $("#Status").val();
                 if (Status == "InActive") {
                      ...
                      $(".ResetToken").prop( "disabled", false );
                 } 
                    });
            ...
            $("#btnSaveUser").on('click', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (Type == "Insert") {
                            alert("Add Complete");
                            console.log("username: " + username + ", name: " + name + ", lastname: " + lastname + ", phone: " + phone + ", email: " + email + ", Status: " + Status + ", Type: " + Type + " ");
                        } else if (Type == "Edit") {
                           
                            if (Status == "InActive") {
                                alert("Please Change Status to Active for Edit");
                            } else if (Status == "Active") {
                                 alert("Edit Complete");
                            }
                               console.log(status);
            ...
            $(document).on('click',".btnEditUser", function (){
                ...
                if (row.find("td:nth-child(4)").text() == "InActive") {
                    $("#txtusername").prop("disabled", true);
                    $("#txtphone").prop("disabled", true);
                    $("#txtEmail").prop("disabled", true);
                    $("#txtname").prop("disabled", true);
            ...
            $(".ResetToken").on('click', function () {
                var name = $("#txtname").val();
                if (confirm("Confirm to Reset Line Token of " + name)) {
                    var username = ($("#txtusername").val());
                    $.ajax({
                        type: "POST",
                        async: false,
