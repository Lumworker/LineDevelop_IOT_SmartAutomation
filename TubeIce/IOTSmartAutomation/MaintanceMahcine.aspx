    ...
    <script>
        $(document).ready(function () {
            ...
            $("#btnClickModalAddCustomerFactory").on('click', function () {
                var row = $(this).closest("tr");
                $("#NameCustomerFactory").text($("#ListCustomerFactory").find("tr").attr("data-cusno"));
                $("#NameSiteFactory").text($("#ListCustomerFactory").find("tr").attr("data-sitecode"));
            ...
            $(document).on('click', '.ClickEditLineFactory', function () {
                var row = $(this).closest("tr");
                $("#NameCustomerFactory").text(row.attr("data-cusno"));
                $("#NameSiteFactory").text(row.attr("data-sitecode"));
            ...
            $("#btnSaveCustomerFactory").on('click', function () {
                ...
                var data = { customer_no: CustomerNo, site_code: SiteNo, factory_no: FactoryCode, factory_name: FactoryName, address: FactoryAddress, phone1: FactoryPhone1, phone2: FactoryPhone2, email: FactoryEmail, fax: FactoryFax, type: type };
                console.log(data);
                $.ajax({
                    type: "POST",
                    async: false,
            ...
            $(document).on('click', '.ClickDeleteLineFactory', function () {
                if (confirm("Are you want for delete Factory?")) {
                    var row = $(this).closest("tr");
                    var CustomerNo = row.attr("data-cusno");
                    var SiteNo = row.attr("data-sitecode");
            ...
            $("#btnClickModalAddCustomerMember").on('click', function () {
                $("#NameCustomerMember").text($("#ListCustomerMember").find("tr").attr("data-cusno"));
                $("#NameSiteMember").text($("#ListCustomerMember").find("tr").attr("data-sitecode"));
            ...
            $(document).on('click', '.ClickEditLineMember', function () {
                var row = $(this).closest("tr");
                $("#NameCustomerMember").text(row.attr("data-cusno"));
                $("#NameSiteMember").text(row.attr("data-sitecode"));
            ...
            $("#buttonModalCustomerMemberCode").on('click', function () {
                var customer_no = $("#ListCustomerMember").find("tr").attr("data-cusno");
                var site_code = $("#ListCustomerMember").find("tr").attr("data-sitecode");
                var factory_no = $("#ListCustomerMember").find("tr").attr("data-factoryno");
            ...
            $("#btnClickModalAddMainMachine").on('click', function () {
                $("#NameCustomerMainMachine").text($("#ListMainMachine").find("tr").attr("data-cusno"));
                $("#NameSiteMainMachine").text($("#ListMainMachine").find("tr").attr("data-sitecode"));
            ...
            $(document).on('click', '.ClickEditLineMainMachine', function () {
                var row = $(this).closest("tr");
                $("#NameCustomerMainMachine").text(row.attr("data-cusno"));
                $("#NameSiteMainMachine").text(row.attr("data-sitecode"));
            ...
            $("#btnSaveMainMachine").on('click', function () {
                ...
                var customer_no = $("#ListMainMachine").find("tr").attr("data-cusno");
                var site_code = $("#ListMainMachine").find("tr").attr("data-sitecode");
                var factory_no = parseInt($("#ListMainMachine").find("tr").attr("data-factoryno"));
                ...
                var data = { customer_no: customer_no, site_code: site_code, factory_no: factory_no, main_machine_ID: main_machine_ID, main_machine_desc: main_machine_desc, main_machine_type: main_machine_type, main_machine_model: main_machine_model, Certificated: Certificated, PLC: PLC, Serial_Number: Serial_Number, Remark: Remark, SetPoint_NextDrop: SetPoint_NextDrop, type: type };
                $.ajax({
                    type: "POST",
                    async: false,
            ...
            $(document).on('click', '.ClickSelectLineFactory', function () {
                ...
                if (row.find("td").find("a").hasClass("SelectLine")) {
                    ...
                    row.find("td").find("a").addClass("SelectLine");
                    CallCustomerMember(row.attr("data-cusno"), row.attr("data-sitecode"), row.find("td:nth-child(1)").text());
                    CallMainMachine(row.attr("data-cusno"), row.attr("data-sitecode"), row.find("td:nth-child(1)").text());
                }
            });
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $.each(response.d, function (index, val) {
                            ...
                            frament += '<tr data-cusno="' + CustomerNo + '" data-sitecode="' + site_code + '">';
                    ...
                    success: function (response) {
                        if (response.d.length > 0) {
                            ...
                            $.each(response.d, function (index, val) {
                                ...
                                var FullName = val[1];
                                var role = val[2];
                                frament += '<tr data-cusno="' + CustomerNo + '" data-sitecode="' + site_code + '" data-factoryno="' + factory_no + '">';
